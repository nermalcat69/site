  ...
  return (
    <div className="min-h-screen flex items-center dark:bg-black">
      <main className="py-6 sm:py-10 px-4 sm:px-8 mx-auto max-w-3xl w-full">
        ...
        <p className="mt-6 mb-4 text-sm sm:text-base leading-relaxed dark:text-neutral-300">I sell tea, matcha, and coffee on the internet involving as much as software possible to make things seamless and sustainable.</p>

        <p className="mb-6 text-sm sm:text-base leading-relaxed dark:text-neutral-300">Before Gray Cup, I spent years programming almost everyday. Freelancing early, then working at a czechian cloud startup even making it easy for newbie customers.</p>
        ...
        <a href="https://instagram.com/shlpaints" className="mt-8 sm:mt-12 block">
        ...
        <p className="text-xs text-end mt-4 dark:text-neutral-400">view the previous/archived version of this website at <a href="https://archived.arjunaditya.xyz" target="_blank">archived.arjunaditya.xyz</a>.</p>
        ...
        <a
          className="inline-block mt-4 mb-6 ml-0 sm:ml-2"
          href="https://cal.com/arjunaditya/30min?user=arjunaditya"
          target="_blank"
        >
