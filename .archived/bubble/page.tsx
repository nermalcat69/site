  ...
  return (
    <main className="prose dark:prose-invert mx-auto p-4 sm:p-8 flex-1 w-full max-w-3xl relative z-10">
      ...
      <p>
        ...
        one bedroom in a two-bedroom apartment in the Mission District. Outside
        of working on my startup, I devoured books on my Kindle and brooded with
        my fellow liberals about Trump and the GOP on Twitter. Most everyone I
        knew was agnostic.
      </p>
      <p>
      ...
      <p>
        Today, I live in Provo, the most conservative (and religious) city over
        100,000 people in America. I live in a one-bedroom apartment that costs
        $800 a month. I no longer tweet as much, and especially not about
        politics. A majority of my friends, including my girlfriend, are
      ...
      <p>
        ...
        attained profitability, and while we can't ship as quickly, Gumroad will
      ...
      <p>
        ...
        hobbies, though I did not have a long-term project to replace Gumroad. I
        was used to solving problems, but now I didn't know what problem to
      ...
      <p>
        I didn't really know what I wanted to do, but I felt like San Francisco
        wasn't going to tell me. My days were filled with friends that thought
        like me, and meetings in which we patted each other on the back. We knew
        the solutions to the world's problems — the rest of the world just had
        to catch up.
      </p>
      <p>
        I wanted to work on something new, and I needed new ideas. So I moved to
        the place most full of people not like me: Provo, Utah. A writing class
        taught by one of my favorite authors, Brandon Sanderson, at Brigham
        Young University served as the final impetus.
      </p>
      <p>
        I did some research in the week between deciding to move to Provo and my
        flight. The facts I learned only bolstered my warped view of the sort of
        people I expected to meet: church-going and God-fearing, very white and
        not very woke. And ecstatic about Trump.
      </p>
      <p>
        If you don't know who I am, you might have assumed a whole lot of things
        about me, too. The clothes I wear. The kinds of food I enjoy. How much I
        swear. If you did, you would have done what I did when I moved to Provo.
        What everyone does when they think about anyone, really, except for
        themselves.
      </p>
      <p>
        So, what did I expect of America's most conservative bubble, a place
        where Hillary Clinton garnered just 14% of the vote and less than 1% of
        the population was black? It sounded like hell to me.
      </p>
      <h2>Culture shock (and lack thereof)</h2>
      <p>
        I gave away all of my furniture and landed in Provo on a Sunday, five
        suitcases in tow, hoping for some grand epiphany about my path forward.
        Three Mormons skipped church to pick me up from the airport. One of them
        had seen my moving announcement on Facebook and sent me a message.
      </p>
      <p>
      ...
      <p>
        "We voted for Evan [McMullin]," Brigham said, indicating himself and his
        friend, David, "and Jesse voted for Hillary. I wish I could have."
      </p>
      <p>"Why?"</p>
      <p>"It's Trump, dude."</p>
      ...
      <p>
        The conversation was a hint of things to come: it was full of apologies.
        Mostly about the Mormons that voted for Trump, but there was also
        genuine admiration for many things about liberal strongholds.
      </p>
      <p>
      ...
      <p>
        ...
        industry was). They spoke ill of their reliance on cars and the negative
        effects on the environment, while I spoke ill of San Francisco's public
        transportation.
      </p>
      <p>
        ...
        the neighborhood gym, and located my default coffee shop. I worked on my
        novel, drew, and had meals with anyone that was willing.
      </p>
      <h2>Learning the language</h2>
      <p>
        I knew I wasn't experiencing a representative data sample of Provo's
        voter demographics — these people were mostly under forty and worked in
        the tech industry or were at least familiar with it — but almost
      ...
      <p>
        Not really, no. I volunteered for Bernie Sanders in the primary. I think
        the Democratic platform is better at solving the problems I care about
        solving.
      </p>
      <p>
        If this was a conversation with an internet stranger, the conversation
        would have ended somewhere around here. Thankfully, it was in person and
        over pizza.
      </p>
      <p>
      ...
      <p>
        ...
        believe that Black people are inferior to White people. That racism was
        part of their soul and identity, and that it was explicit and
        intentional. Of course, when I called a stranger on the internet racist,
      ...
      <p>
        ...
        continue to support a racist system built on a foundation only possible
        by genocide of native peoples.
      </p>
      <p>
      ...
      <p>
        I look back and see the hundreds, if not thousands, of things I tweeted.
        They were funny, maybe, but besides inflate my ego and follower count,
        I'm not sure what impact they had.
      </p>
      <p>
      ...
      <p>
        I have learned plenty from Provo. But here are some things I still hope
        to teach it:
      </p>
      <p>
        ...
        regardless of your skin color. Your lifestyle is infringed upon and your
        vote is disenfranchised. Public transport is closed on Sundays, as well
        as the municipal gym. It would be more welcoming to people like me if
        Sundays didn't feel so hostile.
      </p>
      <p>
        Mormons are scared of the outside world, and I wish they weren't. It is
        not uncommon, at Church or otherwise, to hear that the world is getting
        worse (as Christian doctrine states that it must before the Second
        Coming). This is a belief the vast majority of conservatives hold.
      </p>
      <p>
      ...
      <p>
        ...
        whenever I can. Extreme poverty is shrinking; the polio vaccine has all
        but eradicated the disease; fewer kids are dying in the first five years
        of their life; more humans live under a liberal democracy than ever
        before. This list also grows.
      </p>
      <p>
        ...
        worldview, and many of them have come around to it, just like I have to
        theirs.
      </p>
      <p>
      ...
      <p>
        ...
        aren't taken seriously in San Francisco anymore. I didn't see that. Just
        like conservatives embraced me and my ideas, liberals gave me the same
        grace.
      </p>
      <p>
        I now believe that both sides are composed of mostly open-minded people
        that aren't represented in the NYTimes nor on Fox News nor in the latest
        viral political Tweet. They're at home and at school and at work trying
        to make ends meet. They don't care about that level of exposure. They
        are working privately to solve those problems. Maybe you're one of them!
        If so, hi!
      </p>
      <p>
        When I moved to Provo, I didn't expect to walk in anyone's shoes. I was
        affluent, young, agnostic, and had the freedom in my life to pivot my
        entire life because I felt like it. I was not, and could not pretend to
        be even close to the median American voter. But I am a little closer.
      </p>
      <p>
        Realizing that even the most liberal of governments cannot fix climate
        change alone, I have reduced my consumption of red meat. I have deleted
        Twitter and Reddit off of my phone, and seek to have more in-person
        conversations. I invest more time in my creative hobbies and volunteer
        for causes that I support. I see the value of a Christ-like figure in
        one's life, and support that journey in those around me. And I am
        reignited about the impact that Gumroad and our creators can have upon
        the world, sharing their perspectives through their products.
      </p>
      <p>
        I am not a fundamentally different person than the one I was a year ago,
        but I am a little bit better.
      </p>
